        ...
        <div className={styles.transactionList}>
            {transactions.map((transaction) => (
                <div key={transaction.id} className={styles.transactionItem}>
                    <div className={`${styles.iconContainer} ${transaction.iconBackground}`}>
                        <img src={transaction.icon} alt={`${transaction.title} icon`} className={styles.icon} />
                    </div>
                    ...
                    <div className={styles.amountContainer}>
                        <span className={`${styles.amount} ${transaction.amountStyle}`}>{transaction.amount}</span>
                    </div>
                </div>
            ))}
        </div>
